...
<body class="bg-gray-100">
    <div x-data="{ openSidebar: false }" class="flex h-screen w-full">
        ...
        <div class="hidden lg:flex lg:flex-col lg:w-64 bg-gray-900 text-white lg:fixed lg:inset-y-0 lg:left-0 lg:z-40">
            <!-- Sidebar Header -->
            ...
            <nav class="mt-4 overflow-y-auto">
                                ...
                                <a href="/stocks"
                                    ...
                                    <svg class="w-6 h-6 mr-2" fill="none" stroke="white" stroke-width="2"
                                        ...
                                        <circle cx="12" cy="12" r="7" stroke="#FFFFFF"
                                            stroke-width="2" fill="none" />
                                        <path d="M12 5V8M12 16V19M12 11H9M12 11H15" stroke="#FFFFFF" stroke-width="2"
                            ...
                            <div class="flex items-center">
                                <svg class="w-6 h-6" fill="none" stroke="white" stroke-width="2"
                                    ...
                                    <circle cx="12" cy="7" r="4" stroke="#FFFFFF" stroke-width="2"
                                        fill="none" />
                                    <path d="M4 17C4 14.79 5.79 13 8 13H16C18.21 13 20 14.79 20 17" stroke="#FFFFFF"
                                        stroke-width="2" />
                ...
                @endif
                @if (Auth::guard('company')->check() == true ||
                        Auth::user()->can('view Report Transaction') ||
                        Auth::user()->can('view Profit Loss Statement') ||
                        Auth::user()->can('view Report Cash Flow'))
        ...
        <div x-show="openSidebar" @click.away="openSidebar = false"
            ...
            class="fixed inset-y-0 left-0 w-64 bg-gray-900 text-white z-50 lg:hidden flex flex-col">
        ...
        <!-- Main Content Area - Add margin for desktop sidebar -->
        <div class="flex flex-col flex-1 w-full min-h-screen lg:ml-64">
            ...
            <header class="w-full bg-gray-800 text-white shadow p-4 flex justify-between items-center">
                ...
                <button @click="openSidebar = !openSidebar" class="p-2 rounded hover:bg-gray-700 lg:hidden">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                ...
                <h1 class="text-xl font-bold lg:text-left">@yield('title')</h1>
                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open" @click.away="open = false"
                        ...
                        class="absolute right-0 mt-2 w-48 bg-gray-800 rounded shadow-lg z-50">
                        @if (Auth::guard('company')->check() == true)
