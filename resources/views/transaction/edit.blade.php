...
@section('content')
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg mt-6">
        ...
        <form action="{{ route('transaction.update', $transaction->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select class="w-full bg-white px-4 py-2 border border-gray-300 rounded-md placeholder:capitalize"
                    name="type" id="type">
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" onfocus="this.showPicker()" name="date" placeholder='date'
                    value="{{ old('date', $transaction->date) }}"
                    class="w-full bg-white px-4 py-2 border border-gray-300 rounded-md placeholder:capitalize">
                @error('date')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
                @error('date')
            ...
            <div class="my-4">
                ...
                <input type="text" readonly name="total_price" placeholder='customer name'
    ...
    `;
            ...
            <div class="mb-4 text-left">
                <label class="block text-gray-700 font-medium mb-1">Product ame</label>
            ...
            <div class="mb-4 text-left">
                ...
                <input type="number" id="quantity" value="${quantity}" min="1" readonly class="w-full px-4 py-2 border border-gray-300 rounded-md">
            </div>

            <div class="mb-4 text-left">
                <label class="block text-gray-700 font-medium mb-1">Promo</label>
                <select id="promo" class="bg-white w-full px-4 py-2 border border-gray-300 rounded-md">
                    ${promoOptions}
                </select>
            </div>
