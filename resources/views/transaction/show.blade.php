    ...
    <div class="max-w-5xl mx-auto bg-white p-6 rounded-lg shadow-lg mt-6">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-6">
            <h1 class="text-lg sm:text-xl font-semibold text-gray-800">
                {{ $transaction->customer_name }}'s Transaction Detail
            </h1>

            <div
                class="inline-flex items-center bg-gray-100 text-gray-700 text-sm font-medium px-4 py-2 rounded-md border border-gray-300 shadow-sm">
                Voucher: <span class="ml-2 font-semibold text-indigo-600">{{ $transaction->voucher_code }}</span>
            </div>
        ...
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('transaction.export-pdf', $transaction->id) }}"
                class="bg-stone-600 hover:bg-black transition-all duration-150 text-white py-1 px-4 rounded-lg">
                Export PDF
            </a>
        </div>
