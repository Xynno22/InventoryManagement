                    ...
                    <tbody class="text-center">
                        @foreach ($transactions as $index => $transaction)
                            <tr class="border-gray-200 border-b hover:bg-gray-50 transition">
                                ...
                                <td>{{ $transaction->total_price}}</td> <!-- Menampilkan grand_total -->
                                <td class="px-4 py-3 flex items-center justify-center">
                                    <div class="py-1 flex items-center">
                                        ...
                                        @elseif ($transaction->status->name === 'Pending')
                                            <div class="flex gap-1 items-center justify-center">
                                                <svg xmlns="http://www.w35org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 text-yellow-500">
